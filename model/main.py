...
class Model(object):
    ...
    def dev(self):
        ...
        eval_generator = theano.function(
            inputs=[self.x, self.generator.posit_x, self.bm, self.fw_mask, self.chunk_sizes],
...
def main():
    ...
    position_emb_layer = myio.create_embedding_layer(args, None, [i for i in xrange(51)], 50, oov=None)
