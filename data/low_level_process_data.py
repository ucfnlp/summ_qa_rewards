...
def prune_hl(args):
    ...
    if sentence_bounds[0] is not None:
        print '  shortest sentence', sentence_bounds[0]
        print '  longest sentence', sentence_bounds[1]
...
def prune_type(args, x, y, e, ve, cy, rx, pt, ma, sha, ch, entity_map, used_e, sentence_bounds):
    length = len(y)
    updated_y = []
    updated_cy = []
    updated_e = []
